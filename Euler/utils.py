...
def get_score(nscore, pscore):
    ...
    labels = np.zeros(ntp + ntn, dtype='long')
    labels[:ntp] = 1
...
class WandbLogger:
    """
    Learn from https://github.com/Janspiry/Image-Super-Resolution-via-Iterative-Refinement/blob/b247799a7ae1e1a43ef64384f3dd9194ab0e433c/core/wandb_logger.py.
    ...
    def __init__(self, opt):
        ...
        wandb_path = './Exps/wandb'
        if not os.path.exists(wandb_path): os.makedirs(wandb_path)
