...
# Set dataset paths
# =============
RED = '/mnt/data_center/lambda_jxu/data/lanl/redteam.txt' # Location of redteam.txt
SRC = '/mnt/data_center/lambda_jxu/data/lanl/auth.txt' # Location of auth.txt
DST = '/home/jxu/github/Jbeil/Jbeil/utils/' # Directory to save output files to
SRC_DIR = '/mnt/data_center/lambda_jxu/data/lanl/' # Directory of flows.txt, auth.txt
# =============
...
def split_auth():
    ...
    save_map(nmap, DST +'nmap.pkl')
    save_map(umap, DST +'umap.pkl')
    save_map(atmap, DST +'atmap.pkl')
    save_map(ltmap, DST +'ltmap.pkl')
    save_map(aomap, DST +'aomap.pkl')
    save_map(smap, DST +'smap.pkl')
